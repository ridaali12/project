...
export default function SpecieDetailU() {
      ...
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/(tabs)/HomeScreen')}
          >
            <Text style={styles.backToLibraryText}>Back to Home</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        ...
        <View style={styles.mainCard}>
          ...
          {species.conservationGuide && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                <Ionicons name="shield-outline" size={20} color="#2d6a4f" />
                <Text style={styles.sectionTitle}>Conservation Guide</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  imageContainer: { width: '100%', height: 300, backgroundColor: '#fff' },
  ...
  imagePlaceholderText: { marginTop: 10, fontSize: 14, color: '#999' },
  mainCard: {
    backgroundColor: '#fff',
    marginTop: -20,
  ...
  titleContent: { alignItems: 'flex-start' },
  commonName: {
    fontSize: 28,
    fontWeight: '700',
    color: '#fff',
  ...
  statusBadge: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  statusLabel: {
    fontSize: 12,
    fontWeight: '600',
    color: '#666',
  ...
  statusValue: { fontSize: 16, fontWeight: '700', color: '#2d6a4f' },
  ...
  infoValue: { fontSize: 14, fontWeight: '600', color: '#1a1a1a', textAlign: 'center' },
  errorContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 32 },
  errorText: { fontSize: 18, fontWeight: '600', color: '#1a1a1a', marginTop: 16, textAlign: 'center' },
  backToLibraryButton: {
    marginTop: 24,
  ...
  backToLibraryText: { fontSize: 16, fontWeight: '700', color: '#000' },
});
